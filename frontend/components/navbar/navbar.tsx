            ...
            <div className="navbar-items">
                ...
                <section className="navbar-icons">
                    <a href="https://github.com/thedaebu/reallysmart" target="_blank" rel="noopener noreferrer">
                        <img className="navbar-icons-item" src={window.github} alt="Github" />
                    </a>
                    <a href="https://www.linkedin.com/in/edkim163/" target="_blank" rel="noopener noreferrer">
                        <img className="navbar-icons-item" src={window.linkedin} alt="LinkedIn" />
                    </a>
                    <a href="https://eddie-kim.com/" target="_blank" rel="noopener noreferrer">
                        <img className="navbar-icons-item" src={window.website} alt="Website" />
                    </a>
                </section>
            </div>
        </div>
